...
when st.id in (1,2,6,7,20,21,56,57,92,93,126,127,130,131,164,165,198,199,232,233,266,300,301,302,303,338,339,372,373,407,413,485,523,525) then 'Reselling'
else 'not_set'
end as stock_model,
