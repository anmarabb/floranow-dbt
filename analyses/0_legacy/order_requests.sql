...
--create or replace view `floranow.Floranow_ERP.order_requests` as 
...
case when orr.standing_order_id is not null then 'standing_order' else null end as standing_order,
