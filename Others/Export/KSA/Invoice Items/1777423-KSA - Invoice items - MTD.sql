...
--MTD
where i.financial_administration_id = 1 and ii.status = 'APPROVED' and ii.deleted_at is null and  date_diff(cast(i.printed_at as date), cast(current_date() as date ), MONTH) = 0