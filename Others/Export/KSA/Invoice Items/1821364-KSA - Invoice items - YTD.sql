...
--MTD
where stg_users.financial_administration = 'KSA' and ii.status = 'APPROVED' and ii.deleted_at is null and  date_diff(cast(current_date() as date ),cast(i.printed_at as date), YEAR) = 0