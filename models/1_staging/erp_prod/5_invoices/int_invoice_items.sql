...
quantity as inventory_quantity,
    ...
    case 
        ...
        else 0 end as auto_gross_revenue_mod,
    case
        ...
        else 0 end as manual_gross_revenue,
    ...
    case 
        ...
        else 0 end as auto_credit_note_mod,
    case    
...
case 
    when ii.currency = 'SAR' then 1/3.77
    when ii.currency = 'AED' then 1/3.72
