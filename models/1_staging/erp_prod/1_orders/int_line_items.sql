...
case when li.origin_warehouse_id is null then pi.missing_packing_quantity end as missing_packing_quantity,
case when li.origin_warehouse_id is null then pi.sh_incident_quantity_receiving_stage end as sh_incident_quantity_receiving_stage,
case when li.origin_warehouse_id is null then pi.missing_quantity_receiving_stage end as missing_quantity_receiving_stage,
case when li.origin_warehouse_id is null then damaged_quantity_receiving_stage end as damaged_quantity_receiving_stage,
