...
current_timestamp() as ingestion_timestamp,
 ...
 case 
    ...
    when main_group.hevo_20011600 is not null then main_group.hevo_20011600
    ...
    when main_group.hevo_20010100 is not null then main_group.hevo_20010100
    when main_group.hevo_30003000 is not null then main_group.hevo_30003000
end as main_group,
