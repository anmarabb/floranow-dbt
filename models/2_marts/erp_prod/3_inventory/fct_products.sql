...
case 
  ...
  when Stock = 'Inventory Stock' and live_stock = 'Live Stock' and stock_model in ('Internal') and flag_1 in ('scaned_flag', 'scaned_good') then 'Internal - Current Inventory'
  else null 
